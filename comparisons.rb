...
puts "Does the dog love to play and also loves treats?" 
puts loves_to_play && loves_treats


# Determine if the dog loves to play and loves the dog park
puts "Does the dog love to play and loves the dog park?" 
...
puts "Does the dog love to play and is also a puppy?" 
puts loves_to_play && age <= 1

# What did your final line of code evaluate to? Why do you think that is? Explain.
# ANSWER: 
puts "Answer: True, because he loves to play and his age is less than or equal to 1.
